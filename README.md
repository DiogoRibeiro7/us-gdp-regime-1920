...
If you use this software or its results, please cite the archived release. Machine
-readable metadata is in [CITATION.cff](CITATION.cff); after the Zenodo deposit,
...
([CC-BY-4.0](LICENSE)). You may share and adapt the material, including for
