...
\author{
  Diogo Ribeiro\thanks{All estimates, tables, and figures are reproducible from
  the accompanying open-source pipeline (\texttt{us-gdp-regime-1920}); every
  quantitative statement in the text is generated programmatically from the
  model outputs. Correspondence: \texttt{hansolo.dj@gmail.com}.}
}
